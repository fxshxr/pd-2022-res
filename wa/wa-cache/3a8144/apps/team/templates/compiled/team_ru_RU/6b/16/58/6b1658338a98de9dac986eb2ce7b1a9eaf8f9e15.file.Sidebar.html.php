...
</a></li><?php } ?></ul><?php }else{ ?><p class="hint align-center" style="margin: .5em 0 0;">Нет офисов</p><?php }?></div><div class="block"><ul class="menu-v with-icons"><?php if (teamHelper::hasRights('add_users')&&$_smarty_tpl->tpl_vars['invited_count']->value){?><li><span class="count js-count"><?php echo $_smarty_tpl->tpl_vars['invited_count']->value;?>
</span><a href="<?php echo $_smarty_tpl->tpl_vars['wa_app_url']->value;?>
invited/"><i class="icon16 status-yellow-tiny"></i>Приглашения</a></li><?php }?><?php if (teamHelper::hasRights()&&$_smarty_tpl->tpl_vars['inactive_count']->value){?><li><span class="count js-count"><?php echo $_smarty_tpl->tpl_vars['inactive_count']->value;?>
</span><a href="<?php echo $_smarty_tpl->tpl_vars['wa_app_url']->value;?>
inactive/"><i class="icon16 status-gray-tiny"></i>Заблокированные</a></li><?php }?><!-- plugin hook: 'backend_sidebar.bottom_li' --><?php  $_smarty_tpl->tpl_vars['_'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['_']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['backend_sidebar']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['_']->key => $_smarty_tpl->tpl_vars['_']->value){
$_smarty_tpl->tpl_vars['_']->_loop = true;
