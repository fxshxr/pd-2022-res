<?php /* Smarty version Smarty-3.1.14, created on 2022-10-03 09:32:59
         compiled from "D:\open_server\OSPanel\domains\utke\wa-system\page\templates-legacy\Help.html" */ ?>
<?php /*%%SmartyHeaderCode:720992514633a821bd4b3c0-26943919%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd2f953a477ac0472032d2fb33f6c8f63713eebac' => 
    array (
      0 => 'D:\\open_server\\OSPanel\\domains\\utke\\wa-system\\page\\templates-legacy\\Help.html',
      1 => 1617787741,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '720992514633a821bd4b3c0-26943919',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_633a821bdb8da0_53353664',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_633a821bdb8da0_53353664')) {function content_633a821bdb8da0_53353664($_smarty_tpl) {?><!-- cheat sheet -->
...
" alt="">
            <?php }?>
            <p class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);?>
</p>
            <p>
                <span class="hint"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['apps_info']->value[$_smarty_tpl->tpl_vars['app_id']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
</span>
            </p>
        </li>
    <?php }?>
...
" <?php if ($_smarty_tpl->tpl_vars['app_vars']->first){?>class="selected"<?php }?>>
                    <?php $_smarty_tpl->tpl_vars['_tab_name'] = new Smarty_variable(htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['tab_names']->value[$_smarty_tpl->tpl_vars['id']->value])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8', true), null, 0);?>
                    <?php if (!$_smarty_tpl->tpl_vars['_tab_name']->value){?>
                        <?php $_smarty_tpl->tpl_vars['_tab_name'] = new Smarty_variable(htmlspecialchars($_smarty_tpl->tpl_vars['apps_info']->value[$_smarty_tpl->tpl_vars['id']->value]['name'], ENT_QUOTES, 'UTF-8', true), null, 0);?>
                    <?php }?>
